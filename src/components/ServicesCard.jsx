...
const ServicesCard = ({ service, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className={`pointer-events-none blur-2xl rounded-full bg-gradient-to-r form-blue-500 via-indigo-500 to-purple-500 w-[300px] h-[300px] absolute z-0 transition-opacity duration-500 mix-blend-lighten
