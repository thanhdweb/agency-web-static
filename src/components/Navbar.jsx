...
const Navbar = ({ them, setThem }) => {
    ...
    return (
        <motion.div
            ...
            <img src={them === 'dark' ? assets.logo_dark : assets.logo} className='w-32 sm:w-40' alt='' />
            ...
            <div className='flex items-center gap-2 sm:gap-4'>
                ...
                <ThemeToggleBtn them={them} setThem={setThem} />

                <img src={them === 'dark' ? assets.menu_icon_dark : assets.menu_icon} alt="" onClick={() => setSidebarOpen(true)} className='w-8 sm:hidden' />
