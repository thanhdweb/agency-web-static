    ...
    return (
        <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
            ...
            <motion.div
                ...
                <p className='text-sx font-medium'>Trusted by 10k+ people</p>
            </motion.div>
            ...
            <motion.h1
                ...
                <span className='bg-gradient-to-r form-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent'>digital</span>
                impact.
            </motion.h1>
            ...
            <motion.p
                ...
                viewport={{ once: true }}
                className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-x-4/5 sm:max-w-lg pd-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.
            </motion.p>
